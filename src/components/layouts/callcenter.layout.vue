...
const updateNotifications = () => {
  ...
  if (newRejectedCaseCount.value > 0) {
    notifications.value.push({
      ...
      href: "/callcenter/cases/rejected",
    });
  }
};
function navigation() {
  let navList = [
    {
      name: "Home",
      href: "/callcenter/dashboard",
      icon: HomeIcon,
      current: false,
    },
    {
      name: "Cases",
      href: "/callcenter/cases",
...
const onAbout = async () => {
  $router.push({ path: "/callcenter/about-system" });
};
