                ...
                <div class="px-4 py-5 bg-white sm:p-6">
                  <div class="grid grid-cols-6 gap-2">
                   ...
                   <!--  <div class="col-span-12 sm:col-span-12">
                      <label for="batch" class="block text-sm font-bold text-gray-700">Disaster Name</label>
                    ...
                    <div class="col-span-12 sm:col-span-12">
                      <label for="date_of_occurrence" class="block text-sm font-bold text-gray-700">Date of
                        Occurrence</label>
