 ...
 -->
                ...
                <div class="bg-gray-50 px-4 py-3 sm:flex sm:flex-row-reverse">
                  ...
                  <button @click="cancelRejection" v-if="isRejecting"
                    class="px-4 py-2 mr-3 bg-gray-500 text-white rounded hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-400 inline-flex items-center">
                    Cancel Rejection
                  </button>
                </div>
