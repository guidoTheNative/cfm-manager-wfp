            ...
            <div class="overflow-hidden sm:rounded-md">
              ...
              <div class="px-4 py-3 text-right sm:px-6">
                ...
                style="background-color: #096eb4;"
                  ...
                  class="inline-flex justify-center py-2 px-4 border border-transparent shadow-sm text-sm font-medium rounded-md text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-600">
                  Update Password
                </button>
              </div>
            </div>
