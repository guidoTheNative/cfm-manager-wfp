<template>
  <div v-if="isOpen" class="fixed z-10 inset-0 overflow-y-auto" @click.self="$emit('close')">
        ...
        <div class="bg-white px-1 pt-5 pb-4 sm:p-6 sm:pb-4">
          <div class="sm:flex sm:items-start">
            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
              <h3 class="text-lg leading-6 font-bold text-gray-900" id="modal-title">Loading Plan Attachments</h3>
              <div class="mt-2">
              ...
              <div class="mt-4">
                <h4 class="text-md leading-6 font-bold text-gray-900"> Uploaded Files</h4>
                        ...
                        <div class="flex items-center">
                          <div>
                            <div class="text-sm font-bold text-gray-900">
                              <a :href="file.url" target="_blank" class="text-[#096eb4] hover:underline">{{ file.name
                                }}</a>
                            </div>
    ...
    " target="_blank" class="text-[#096eb4] hover:text-blue-900">
                          Download
                        </button>
        ...
        <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
          <button type="button"
            class="w-full inline-flex justify-center rounded-md border border-transparent shadow-sm px-4 py-2 bg-blue-400 text-base font-bold text-white hover:bg-blue-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-400 sm:ml-3 sm:w-auto sm:text-sm"
            @click="submit">Submit</button>
          <button type="button"
            class="mt-3 w-full inline-flex justify-center rounded-md border border-gray-300 shadow-sm px-4 py-2 bg-white text-base font-bold text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:mt-0 sm:w-auto sm:text-sm"
