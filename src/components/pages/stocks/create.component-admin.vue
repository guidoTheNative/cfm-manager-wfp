                ...
                <div class="px-4 py-5 bg-white sm:p-6">
                  <div class="grid grid-cols-6 gap-2">
                    ...
                    <div class="col-span-6 sm:col-span-3">
                      <label for="commodity-search" class="block text-sm font-bold text-gray-700">
                        Select Commodity
                      </label>
                    ...
                    <div class="col-span-6 sm:col-span-3">
                      <label for="activity-search" class="block text-sm font-bold text-gray-700">
                        Select Activity
                      </label>
                    ...
                    <div class="col-span-6 sm:col-span-3">
                      <label for="warehouse-search" class="block text-sm font-bold text-gray-700">
                        Select Warehouse
                      </label>
