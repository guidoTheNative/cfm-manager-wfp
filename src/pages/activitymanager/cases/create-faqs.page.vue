      ...
      <div class="bg-white shadow-0 rounded-lg p-6">
        <form @submit.prevent="submitForm">
          ...
          <div class="px-4 py-3 bg-gray-50 text-right sm:px-6 space-x-2">
            <button
              type="submit"
              class="inline-block px-6 py-2.5 text-white font-bold text-xs leading-tight rounded shadow-0"
              :class="
                isEditing
            ...
            <button
              v-if="isEditing"
              type="button"
              class="inline-block px-6 py-2.5 bg-red-600 hover:bg-red-700 text-white font-bold text-xs leading-tight rounded shadow-0"
              @click="cancelEdit"
            >
              Cancel Edit
            </button>
