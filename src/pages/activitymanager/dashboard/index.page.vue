    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8">
      ...
      <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 mt-4">
        ...
        <div class="shadow rounded-lg p-4 bg-white">
          <h3 class="text-lg font-medium text-green-600">Cases by Category</h3>
          <ul class="mt-2">
            <li
        ...
        <div class="shadow rounded-lg p-4 bg-white">
          <h3 class="text-lg font-medium text-yellow-600">Cases by Priority</h3>
          <ul class="mt-2">
            <li
...
// Fetch data on mount
onMounted(async () => {
  const data = await casesStore.getactivityofficerSummary();
