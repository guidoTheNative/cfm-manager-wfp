    ...
    <div class="w-full">
        ...
        <div class="overflow-x-auto relative bg-white p-6 rounded-lg shadow-lg mt-4">
            <div class="flex items-center space-x-4 mb-4">
                ...
                <div class="flex flex-col">
                    <label for="warehouse" class="text-sm font-bold text-gray-700 mb-2">Warehouse</label>
                ...
                <div class="flex flex-col">
                    <label for="commodityType" class="text-sm font-bold text-gray-700 mb-2">Commodity Type</label>
                ...
                <div class="flex flex-col">
                    <label for="expiryDate" class="text-sm font-bold text-gray-700 mb-2">Expiry Date</label>
                ...
                <thead class="bg-blue-50">
                    <tr>
                        ...
                        <th scope="col"
                            ...
                            Warehouse</th>
                        <th scope="col"
                            class="px-6 py-3 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Batch
                            Number</th>
                        <th scope="col"
                            class="px-6 py-3 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">
                            Expiry Date</th>
                        <th scope="col"
                            class="px-6 py-3 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Stock
                            Available</th>
                        <th scope="col"
                            class="px-6 py-3 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Unit
                        </th>
                        <th scope="col"
                            class="px-6 py-3 text-left text-xs font-bold text-gray-500 uppercase tracking-wider">Stock
                            Pending Dispatch</th>
