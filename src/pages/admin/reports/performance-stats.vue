    ...
    <main class="bg-transparent min-h-screen">
      ...
      <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div class="flex items-center justify-between mt-6">
          ...
          <button
            type="button"
            class="font-body inline-flex items-center px-6 py-2.5 bg-gray-500 text-white font-medium text-sm rounded shadow-md hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-gray-500 focus:ring-offset-2 transition duration-150 ease-in-out capitalize"
            @click="generateExcel"
          >
