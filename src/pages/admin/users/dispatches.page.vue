  ...
  <main class="">
    ...
    <div class="max-w-2xl mx-auto px-2 sm:px-6 lg:max-w-5xl lg:px-2">
      ...
      <div class="md:flex md:items-center md:justify-between">
        ...
        <button type="button" 
          class="font-body inline-block px-6 py-2.5 mt-2 bg-gray-500 text-white font-medium text-xs leading-tight rounded shadow-md hover:bg-gray-400 hover:shadow-lg focus:bg-gray-500 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-blue-400 active:shadow-lg transition duration-100 ease-in-out capitalize"
