    ...
    <div class="max-w-2xl mx-auto px-2 sm:px-6 lg:max-w-5xl lg:px-2">
      ...
      <div class="md:flex md:items-center md:justify-between">
        ...
        <div class="mt-4 flex-shrink-0 flex md:mt-0 md:ml-4">
          <router-link :to="{ path: '/field/cases/create/' }">
            <a
              href="#"
        ...
        >
          <template #table-row="props">
            ...
            >
              <!-- Manage Button -->
              <router-link
                :to="`/field/cases/manage/${props.row.id}`"
...
const getCases = async () => {
  ...
  try {
    ...
    cases.push(
      ...result
        // Filter where the district matches user.value.district
        .filter((caseItem) => caseItem.district === user.value.district)
        .map((caseItem) => ({
          ...caseItem,
