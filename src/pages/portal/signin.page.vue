        ...
        <form @submit="onSubmit" :validation-schema="schema" class="space-y-6">
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center">
              <input
                ...
                type="checkbox"
                v-model="isPwd"
                class="h-4 w-4 text-[#096eb4] border-gray-300 rounded focus:ring-blue-400"
              />
          ...
          <div>
            <button
              type="submit"
              style="background-color: #096eb4"
              class="w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-bold text-white hover:bg-blue-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-400"
            >
              Sign in
            </button>
          </div>
