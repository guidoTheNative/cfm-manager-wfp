    ...
    <div class="relative max-w-xl mx-auto">
      ...
      <div class="mt-12">
        ...
        <form @submit="onSubmit" :validation-schema="schema" class="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8"
          ...
          <div class="sm:col-span-2">
            <button type="submit"
              class="font-body w-full inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-blue-400 hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500">
              Submit
            </button>
          </div>
        </form>
